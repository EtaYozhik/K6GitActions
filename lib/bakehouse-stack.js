...
export class BakehouseStack extends Stack {
  constructor (scope, id, props) {
    ...
    // ----------------------------------
    const githubOrg = props.githubOrg || 'EtaYozhik'
    const githubRepo = props.githubRepo || 'K6GitActions'
    ...
    const githubActionsDeployRole = new iam.Role(this, 'github-actions-deploy-role', {
      roleName: 'github-actions-carter-singh-bakehouse',
    ...
    //grand lambdas access to DynamoDb
...
// making a change to push to git and test the cdk deploy
